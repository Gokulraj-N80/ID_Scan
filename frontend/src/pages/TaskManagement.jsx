                  ...
                  <div className="relative">
                    ...
                    {activeDropdownTaskId === task._id && (
                      <>
                        ...
                        />
                        <div className="absolute left-0 bottom-full mb-2 z-20 w-36 bg-white border border-slate-200/90 rounded-2xl shadow-xl p-1.5 space-y-0.5 animate-fade-in-up">
